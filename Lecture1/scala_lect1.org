...
- Please be patient: that's my first year here (report typo,
  comments per email)
**** Today
- Understand the place of programming in Informatics
- Basics of Scala
...
#+LaTeX: \pause\vspace{-.6\baselineskip}
...
#+END_LaTeX
**** Conclusions
- Informatics = Mixup of Maths, Engineering and Natural Science. 
...
#+LaTeX: \vspace{-.3\baselineskip}
- \alert{Computer Scientists are very bad in Computational Science!}\\
...
- Often cleaver and sometimes tricky. Who don't like mind challenges?
  ...
  \begin{columns}
    \begin{column}{.95\linewidth}
      \begin{Verbatim}[gobble=8,fontsize=\footnotesize,frame=single]
        ...
        scala> a
        res1: List[Array[Int]] = List(Array(1000, 2, 3), Array(4, 5), Array(6))
...
\hfill
\includegraphics[width=.25\linewidth]{img/Scala_in_depth.png}
\hfill\null

\bigskip
#+LaTeX: \centerline{\includegraphics[width=.5\linewidth]{img/scala-lang.png}}
#+LaTeX: \centerline{\url{http://scala-lang.org}}
